...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'META card' },
    { src: 'green', alt: 'Green META card with up arrow' },
    { src: 'red', alt: 'Red META card with down arrow' },
    { src: 'top-right', alt: 'META card' },
  ],
}
